...
return o[r]=e[r]+e[l]/2-n[l]/2,o[a]=i===a?e[a]-n[d]:e[P(a)],o}
/**
...
/**
   ...
   * @argument {Object} options - Modifiers configuration and options
   * @returns {Object} The data object, properly modified
   */function ht(t){var e=t.placement,i=e.split("-")[0],n=t.offsets,o=n.popper,s=n.reference,r=-1!==["left","right"].indexOf(i),a=-1===["top","left"].indexOf(i);return o[r?"left":"top"]=s[i]-(a?o[r?"width":"height"]:0),t.placement=P(e),t.offsets.popper=k(o),t}
/**
...
/**
     ...
     * ------------------------------------------------------------------------
     */
mt.fn[vt]=xt._jQueryInterface,mt.fn[vt].Constructor=xt,mt.fn[vt].noConflict=function(){return mt.fn[vt]=Tt,xt._jQueryInterface},xt),mt,vt,yt,_t,wt,bt,Tt,kt,Ct,St,Et,At,xt,Dt=(Ot="button",$t="4.1.1",Pt="."+(Nt="bs.button"),jt=".data-api",Ht=(It=e).fn[Ot],Lt="active",Mt="btn",Ft='[data-toggle^="button"]',zt='[data-toggle="buttons"]',Rt="input",Ut=".active",Bt=".btn",Qt={CLICK_DATA_API:"click"+Pt+jt,FOCUS_BLUR_DATA_API:(Wt="focus")+Pt+jt+" blur"+Pt+jt
/**
       * ------------------------------------------------------------------------
       * Class Definition
       * ------------------------------------------------------------------------
...
/**
     ...
     * ------------------------------------------------------------------------
     */
xe.fn[De]=qe._jQueryInterface,xe.fn[De].Constructor=qe,xe.fn[De].noConflict=function(){return xe.fn[De]=Pe,qe._jQueryInterface},qe),xe,De,Ie,Oe,$e,Ne,Pe,je,He,Le,Me,We,Fe,ze,Re,Ue,Be,Qe,qe,Ke="undefined"!=typeof window&&"undefined"!=typeof document,Ye=["Edge","Trident","Firefox"],Ve=0,Xe=0
/**
   * --------------------------------------------------------------------------
...
/**
   ...
   * --------------------------------------------------------------------------
   */
var hi=(gi="dropdown",mi="4.1.1",yi="."+(vi="bs.dropdown"),_i=".data-api",wi=(fi=e).fn[gi],bi=27,Ti=32,ki=9,Ci=38,Si=40,Ei=3,Ai=new RegExp("38|40|27"),xi={HIDE:"hide"+yi,HIDDEN:"hidden"+yi,SHOW:"show"+yi,SHOWN:"shown"+yi,CLICK:"click"+yi,CLICK_DATA_API:"click"+yi+_i,KEYDOWN_DATA_API:"keydown"+yi+_i,KEYUP_DATA_API:"keyup"+yi+_i},Di="disabled",Ii="show",Oi="dropup",$i="dropright",Ni="dropleft",Pi="dropdown-menu-right",ji="dropdown-menu-left",Hi="position-static",Li='[data-toggle="dropdown"]',Mi=".dropdown form",Wi=".dropdown-menu",Fi=".navbar-nav",zi=".dropdown-menu .dropdown-item:not(.disabled):not(:disabled)",Ri="top-start",Ui="top-end",Bi="bottom-start",Qi="bottom-end",qi="right-start",Ki="right-end",Yi="left-start",Vi="left-end",Xi={offset:0,flip:!0,boundary:"scrollParent",reference:"toggle",display:"dynamic"},Gi={offset:"(number|string|function)",flip:"boolean",boundary:"(string|element)",reference:"(string|element)",display:"string"
/**
       * ------------------------------------------------------------------------
       * Class Definition
       * ------------------------------------------------------------------------
...
/**
     ...
     * ------------------------------------------------------------------------
     */
Xn.fn[Gn]=po._jQueryInterface,Xn.fn[Gn].Constructor=po,Xn.fn[Gn].noConflict=function(){return Xn.fn[Gn]=eo,po._jQueryInterface},po),Xn,Gn,Zn,Jn,to,eo,io,no,oo,so,ro,ao,lo,co,uo,po,ho=(go="scrollspy",mo="4.1.1",yo="."+(vo="bs.scrollspy"),_o=".data-api",wo=(fo=e).fn[go],bo={offset:10,method:"auto",target:""},To={offset:"number",method:"string",target:"(string|element)"},ko={ACTIVATE:"activate"+yo,SCROLL:"scroll"+yo,LOAD_DATA_API:"load"+yo+_o},Co="dropdown-item",So="dropdown-menu",Eo="active",Ao='[data-spy="scroll"]',xo=".active",Do=".nav, .list-group",Io=".nav-link",Oo=".nav-item",$o=".list-group-item",No=".dropdown",Po=".dropdown-item",jo=".dropdown-toggle",Ho="offset",Lo="position"
/**
       * ------------------------------------------------------------------------
       * Class Definition
       * ------------------------------------------------------------------------
...
i=i.map(function(t){return t+'[data-target="'+e+'"],'+t+'[href="'+e+'"]'});var n=fo(i.join(","));n.hasClass(Co)?(n.closest(No).find(jo).addClass(Eo),n.addClass(Eo)):(
...
/**
     ...
     * ------------------------------------------------------------------------
     */
fo.fn[go]=Mo._jQueryInterface,fo.fn[go].Constructor=Mo,fo.fn[go].noConflict=function(){return fo.fn[go]=wo,Mo._jQueryInterface},Mo),fo,go,mo,vo,yo,_o,wo,bo,To,ko,Co,So,Eo,Ao,xo,Do,Io,Oo,$o,No,Po,jo,Ho,Lo,Mo,Wo=(zo="tab",Ro="4.1.1",Bo="."+(Uo="bs.tab"),Qo=".data-api",qo=(Fo=e).fn.tab,Ko={HIDE:"hide"+Bo,HIDDEN:"hidden"+Bo,SHOW:"show"+Bo,SHOWN:"shown"+Bo,CLICK_DATA_API:"click"+Bo+Qo},Yo="dropdown-menu",Vo="active",Xo="disabled",Go="fade",Zo="show",Jo=".dropdown",ts=".nav, .list-group",es=".active",is="> li > .active",ns='[data-toggle="tab"], [data-toggle="pill"], [data-toggle="list"]',os=".dropdown-toggle",ss="> .dropdown-menu .active"
/**
       * ------------------------------------------------------------------------
       * Class Definition
       * ------------------------------------------------------------------------
...
// -- Initialization --
r=T(t,s,e.handlers,e.handler),d.attr(I,"false").addClass("lity-loading lity-opened lity-"+r.handler).appendTo("body").focus().on("click","[data-lity-close]",function(t){u(t.target).is("[data-lity-close]")&&s.close()}).trigger("lity:open",[s]),_(s),u.when(r.content).always(o)}function C(t,e,i){t.preventDefault?(t.preventDefault(),t=(i=u(this)).data("lity-target")||i.attr("href")||i.attr("src")):i=u(i);var n=new k(t,u.extend({},i.data("lity-options")||i.data("lity"),e),i,S.activeElement);if(!t.preventDefault)return n}var S=t.document,E=u(t),A=u.Deferred,x=u("html"),D=[],I="aria-hidden",O="lity-"+I,$='a[href],area[href],input:not([disabled]),select:not([disabled]),textarea:not([disabled]),button:not([disabled]),iframe,object,embed,[contenteditable],[tabindex]:not([tabindex^="-"])',N={esc:!0,handler:null,handlers:{image:e,inline:s,youtube:a,vimeo:l,googlemaps:c,facebookvideo:d,iframe:f},template:'<div class="lity" role="dialog" aria-label="Dialog Window (Press escape to close)" tabindex="-1"><div class="lity-wrap" data-lity-close role="document"><div class="lity-loader" aria-hidden="true">Loading...</div><div class="lity-container"><div class="lity-content"></div><button class="lity-close" type="button" aria-label="Close (Press escape to close)" data-lity-close>&times;</button></div></div></div>'},P=/(^data:image\/)|(\.(png|jpe?g|gif|svg|webp|bmp|ico|tiff?)(\?\S*)?$)/i,j=/(youtube(-nocookie)?\.com|youtu\.be)\/(watch\?v=|v\/|u\/|embed\/?)?([\w-]{11})(.*)?/i,H=/(vimeo(pro)?.com)\/(?:[^\d]+)?(\d+)\??(.*)?$/,L=/((maps|www)\.)?google\.([^\/\?]+)\/?((maps\/?)?\?)(.*)/i,M=/(facebook\.com)\/([a-z0-9_-]*)\/videos\/([0-9]*)(.*)?$/i,W=function(){var t=S.createElement("div"),e={WebkitTransition:"webkitTransitionEnd",MozTransition:"transitionend",OTransition:"oTransitionEnd otransitionend",transition:"transitionend"};for(var i in e)if(void 0!==t.style[i])return e[i];return!1}();return e.test=function(t){return P.test(t)},C.version="2.3.1",C.options=u.proxy(h,C,N),C.handlers=u.proxy(h,C,N.handlers),C.current=b,u(S).on("click.lity","[data-lity]",C),C}),// Generated by CoffeeScript 1.9.2
/**
